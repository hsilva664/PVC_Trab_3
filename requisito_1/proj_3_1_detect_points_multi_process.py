...
if __name__ == '__main__':
    ...
    cv_file_points = cv2.FileStorage('points.xml', cv2.FILE_STORAGE_WRITE)
    ...
    cv2.imwrite('detected_left.png',cL)
    cv2.imwrite('detected_right.png',cR)
