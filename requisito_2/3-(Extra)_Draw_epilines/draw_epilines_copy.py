...
base_folder = '../1-Rectification/Image_Settings/DIFFERENT_CAMERAS_SETTINGS/TOO_CLOSE_SETTING'
...
intrinsics_filename = '../1-Rectification/Parameters/Iphone/Intrinsics.xml'
...
distortion_filename = '../1-Rectification/Parameters/Iphone/Distortion.xml'
...
cv2.imwrite('req3_epi_setting_C_right.jpg',img3)
cv2.imwrite('req3_epi_setting_C_left.jpg',img4)
cv2.imwrite('req3_epi_setting_C_rectified_right.jpg',leftOutput)
