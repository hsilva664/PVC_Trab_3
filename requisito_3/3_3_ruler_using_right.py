...
# baseFolder = '../requisito_2/1-Rectification/Image_Settings/DIFFERENT_CAMERAS_SETTINGS/TOO_CLOSE_SETTING/setting_1'
...
image_name = os.path.join(rectified_folder,'janelaR.jpg')
...
def getClosestPoint(point): #format (i,j) and as numpy array
    minimum_distance_vector = np.linalg.norm(imgRightPositions - point, axis=1)
    ...
    if event == cv2.EVENT_LBUTTONUP:
        if param['window'] == 'Raw Window':
            ...
            if raw_first_click:
                ...
                closest_initial_point = imgRightPositions[initial_point_index,:]                
                ...
                closest_final_point = imgRightPositions[final_point_index,:]
            ...
            if raw_calculate_distance:                
                ...
                # print(initial_point_index)
                # print(final_point_index)
                ...
                # print(initial_point_3D)
                # print(final_point_3D)
